...
namespace ysh{
    ...
    // 版本号
    static std::string version = "22.5.10";
    // 完整版本
    static std::string completeVersion = "Instable-2022-5-0010";
    // 指令方法类型
    ...
    static std::vector insPool = {ins("help", insHelp), ins("info", insInfo), ins("exit", insExit), ins("", insEVAL)};
